...
CREATE TABLE IF NOT EXISTS narrative_cluster_shadow (
    ...
    creator_first_buy_after_secs        DOUBLE PRECISION,
    creator_first_buy_progress_pct      DOUBLE PRECISION,
    creator_last_buy_after_secs         DOUBLE PRECISION,
    creator_last_buy_progress_pct       DOUBLE PRECISION,
